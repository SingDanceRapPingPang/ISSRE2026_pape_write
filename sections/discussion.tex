...
\textbf{Lesson 1: Full-property regression is necessary.} In industrial
...
they remove problematic behavior. For industrial systems, such repairs are
not acceptable.
...
models. It may not represent all industrial timed-automata models.
Larger proprietary models, richer data variables, and more
...
\textbf{Property selection.} Industry-case properties were selected
...
numerical clock-bound edits in guards and invariants \cite{koelbl2019clock}. Some
