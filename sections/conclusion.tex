...
industrial timed-automata models. The method addresses a practical
limitation of local TDT-based repair: industrial models are commonly
...
Our evaluation on benchmark and industry timed-automata datasets shows
that MPTA-Repair improves repair success over an iterative TARTAR-style
baseline, especially on industry cases
