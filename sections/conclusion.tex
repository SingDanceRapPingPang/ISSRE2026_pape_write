...
analysis further indicates that unsuccessful repairs are mainly caused by
the difficulty of finding an admissible candidate within the given time
budget, especially when dense timing interactions substantially enlarge
the clock-bound repair search space.
