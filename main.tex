...
\begin{document}
\title{MPTA-Repair: Simultaneous Multi-Property Clock Bound Repair for Networks of Timed Automata via Iterative Space Optimization}
\author{%
\IEEEauthorblockN{Guangtong Zhou, Run Chang, Ji Wu\textsuperscript{*}\thanks{The implementation and datasets are publicly available at
\url{https://github.com/zhougut/MPTA-Repair}.}}
